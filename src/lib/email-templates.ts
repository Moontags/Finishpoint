    ...
    <div style="${baseStyles}">
      ...
      <div style="padding:24px;">
        ...
        <p style="font-size:13px;color:#555;">
          ...
          <a href="mailto:kuljetus@finishpoint.fi">kuljetus@finishpoint.fi</a>
      ...
      <div style="background:#f5f5f5;padding:16px;text-align:center;font-size:12px;color:#888;">
        Finishpoint Pikakuljetus |
        Y-tunnus: 3163260-9 |
        <a href="https://finishpoint.fi">finishpoint.fi</a>
      </div>
    </div>
  `;
}
...
export function generateReceiptHtml(order: OrderData): string {
  ...
  return `
    <div style="font-family:Arial,sans-serif;color:#1a1a1a;max-width:600px;width:100%;margin:0 auto;box-sizing:border-box;">
      ...
      <div style="background:#f5f5f5;padding:16px;text-align:center;font-size:12px;color:#888;">
        Finishpoint Pikakuljetus | Y-tunnus: 3163260-9 |
        <a href="https://finishpoint.fi">finishpoint.fi</a> |
        kuljetus@finishpoint.fi | 050 354 7763
      </div>
    </div>
  `;
}
