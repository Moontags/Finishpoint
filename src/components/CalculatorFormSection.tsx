      ...
      <section className="relative z-10">
        <section className="relative z-10 mx-auto flex min-h-dvh max-w-7xl flex-col px-4 py-8 max-[390px]:px-3 sm:px-6 lg:px-8 lg:py-12">
          <div className="mx-auto mb-6 max-w-150 text-center sm:mb-8">
            ...
            <p className="mx-auto mb-3 inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white/70 px-3.5 py-1.5 text-[11px] font-extrabold uppercase tracking-[0.14em] text-slate-900 backdrop-blur-sm sm:text-[13px] sm:tracking-[0.18em]">
